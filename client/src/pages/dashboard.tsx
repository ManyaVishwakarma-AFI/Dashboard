...
import Chatbot from "@/components/chatbot/chatbot"; // ADD THIS (your existing chatbot)
import { Button } from "@/components/ui/button";
import { Bell, X, Filter } from "lucide-react";
import { Card, CardContent } from "@/components/ui/card";
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="ml-64 min-h-screen">
        ...
        <div className="p-6 space-y-6">
          ...
          <AIRecommendations 
            userLocation={user?.location || "Delhi, India"} 
          />

          {/* Filter Panel */}
          {showFilters && <FiltersPanel onFiltersApply={handleFiltersApply} />}

          {/* Dashboard Components - Now with AI summaries in charts */}
          <MetricsCards filters={appliedFilters} />
          <ChartsGrid filters={appliedFilters} />
          <ProductRankings filters={appliedFilters} />
        </div>
      ...
      {/* 🔥 ADD CHATBOT HERE - Floating at bottom-right */}
      <Chatbot />
    </div>
  );
}