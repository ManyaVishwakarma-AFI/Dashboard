...
//     {
//       id: "welcome",
//       message: "👋 Hi! I'm your Dashboard Assistant.\n\nI can help you:\n• Understand charts and metrics\n• Find specific data insights\n• Get recommendations\n• Navigate features\n\nWhat would you like to know?",
//       isUser: false,
//       timestamp: new Date()
//     }
//   ]);
...
//         id: Date.now().toString(),
//         message: data.answer || "I'm having trouble getting that information.",
//         isUser: false,
//         timestamp: new Date()
//       }]);
//     } catch (err) {
//       setMessages(prev => [...prev, {
//         id: Date.now().toString(),
//         message: "⚠️ Connection issue. Please ensure the AI service is running.",
//         isUser: false,
//         timestamp: new Date()
//       }]);
//     } finally {
...
//       <Button
//         onClick={() => setIsOpen(!isOpen)}
//         className="w-14 h-14 rounded-full text-white flex items-center justify-center bg-gradient-to-r from-primary to-purple-600 hover:scale-105 transition-all shadow-lg"
//       >
//         {isOpen ? <X className="h-6 w-6" /> : <MessageCircle className="h-6 w-6" />}
//       </Button>

//       {isOpen && (
//         <Card className="absolute bottom-16 right-0 h-[28rem] shadow-2xl border overflow-hidden flex flex-col rounded-2xl">
//           <CardHeader className="bg-gradient-to-r from-primary to-purple-600 text-white p-3 flex flex-row items-center justify-between">
//             <div className="flex items-center space-x-2">
//               <Avatar className="h-8 w-8">
//                 <AvatarFallback className="bg-white/20 text-white">
//                   <Bot className="h-4 w-4" />
...
//               </Avatar>
//               <div>
//                 <CardTitle className="text-sm font-medium">Dashboard Assistant</CardTitle>
//                 <Badge variant="secondary" className="text-xs bg-white/20 border-0 text-white mt-0.5">
//                   Always Here to Help
//                 </Badge>
//               </div>
//             </div>
...
//                     <div className={`max-w-[75%] rounded-lg p-2 text-sm ${msg.isUser ? "bg-primary text-white" : "bg-gray-100 text-gray-900"}`}>
...
//                 </SelectTrigger>
//                 <SelectContent>
//                   <SelectItem value="products">🛍️ Products</SelectItem>
//                   <SelectItem value="amazon_reviews">💬 Reviews</SelectItem>
//                 </SelectContent>
//               </Select>
...
//                 />
//                 <Button onClick={() => sendMessage()} disabled={!inputMessage.trim()} size="sm" className="px-3">
//                   <Send className="h-4 w-4" />
//                 </Button>
//               </div>
//             </div>
